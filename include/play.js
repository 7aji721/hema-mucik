    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        case "⏩":
          ...
          const skipembed = new MessageEmbed().setColor("#8F00FF").setAuthor(`${user.username} skipped the song.`, "https://cdn.discordapp.com/attachments/748633941912584333/753201474691137647/next.png")
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            const pausemebed = new MessageEmbed().setColor("#8F00FF")
            ...
            const playembed = new MessageEmbed().setColor("#8F00FF")
        ...
        case "🔁":
          ...
          const loopembed = new MessageEmbed().setColor("#8F00FF")
        ...
        case "⏹️":
          ...
          if (!canModifyQueue(member)) return;
          queue.songs = [];
          const stopembed = new MessageEmbed().setColor("#8F00FF").setAuthor(`${user.username} stopped the music!`, "https://cdn.discordapp.com/emojis/769915194066862080.png")
